...
export const salesTranslations = {
    zh: {
        ...
        'sales.field.paymentFee': '付款费用',
        'sales.field.discount': '折扣',
        'sales.field.adjustment': '其他调整',
        'sales.field.totalAmount': '订单总计',
        'sales.field.shippingAddress': '收货地址',
        'sales.field.contactPerson': '联系人',
        'sales.field.contactPhone': '电话',
        'sales.field.mobile': '手机',
        'sales.field.addressName': '地址名称',
        'sales.field.defaultAddress': '默认地址',
        'sales.field.addressStatus': '地址状态',
        'sales.field.addressEmail': '邮箱',
        'sales.field.company': '公司名称',
        'sales.field.taxNumber': '税号',
        'sales.field.country': '国家',
        'sales.field.province': '州/省',
        'sales.field.city': '城市',
        'sales.field.district': '区/县',
        'sales.field.addressLine1': '地址1',
        'sales.field.addressLine2': '地址2',
        'sales.field.postalCode': '邮编',
        'sales.field.addressRemark': '地址备注',
        'sales.field.yes': '是',
        'sales.field.no': '否',
    ...
    en: {
        ...
        'sales.field.paymentFee': 'Payment Fee',
        ...
        'sales.field.contactPhone': 'Phone',
        'sales.field.mobile': 'Mobile',
        'sales.field.addressName': 'Address Name',
        'sales.field.defaultAddress': 'Default Address',
        'sales.field.addressStatus': 'Address Status',
        'sales.field.addressEmail': 'Email',
        'sales.field.company': 'Company',
        'sales.field.taxNumber': 'Tax Number',
        'sales.field.country': 'Country',
        'sales.field.province': 'State/Province',
        'sales.field.city': 'City',
        'sales.field.district': 'District',
        'sales.field.addressLine1': 'Address Line 1',
        'sales.field.addressLine2': 'Address Line 2',
        'sales.field.postalCode': 'Postal Code',
        'sales.field.addressRemark': 'Address Remark',
        'sales.field.yes': 'Yes',
        'sales.field.no': 'No',

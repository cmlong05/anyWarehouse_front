...
RUN bun install --frozen-lockfile --verbose --registry https://registry.npmmirror.com
...
RUN bun install --production --frozen-lockfile --verbose --registry https://registry.npmmirror.com
